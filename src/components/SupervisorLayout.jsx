      ...
      <nav className="supervisor-navbar">
        <div className="navbar-brand">
          <svg width="32" height="32" viewBox="0 0 48 48" fill="none">
            ...
            <defs>
              <linearGradient id="navGradient" x1="0" y1="0" x2="48" y2="48">
                <stop offset="0%" stopColor="hsl(250, 84%, 54%)" />
                <stop offset="100%" stopColor="hsl(280, 70%, 60%)" />
              </linearGradient>
            </defs>
          </svg>
          <span className="brand-text">Quản Lý Đề Tài</span>
        </div>
        ...
        <div className="navbar-menu">
          ...
          <Link to="/supervisor/theses" className="nav-link">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="navbar-user">
          <div className="user-info">
            ...
            <div className="user-details">
              ...
              <div className="user-role">Giảng viên HD</div>
            </div>
          </div>
